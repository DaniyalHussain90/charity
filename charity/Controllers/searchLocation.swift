...
class searchLocation: UIViewController, UISearchBarDelegate, MKLocalSearchCompleterDelegate {
...
extension searchLocation: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        search.start { (response, error) in
         ...
         //   let lonPositive = abs(lon)
            print(lat)
            print(lon)
            
            let DataDict:[String: Any] = ["locName": name,
                                          "locLat": lat,
                                          "locLongitude": lon
            ]
            
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: "notification"), object: nil, userInfo: DataDict)
